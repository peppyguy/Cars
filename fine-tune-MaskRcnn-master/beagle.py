...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("beagle", 1, "Frame")
        self.add_class("beagle", 2, "Wheels")
        self.add_class("beagle", 3, "Screw")
        self.add_class("beagle", 4, "Body")
        self.add_class("beagle", 5, "Engine")
        self.add_class("beagle", 6, "Screw_driver")
